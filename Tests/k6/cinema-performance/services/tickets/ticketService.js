...
export class TicketsService extends BaseRest {
    ...
    createTicket(ticketData, headers, maxResponseTime = undefined) {
    ...
    getTickets(page = 1, limit = 10, headers, maxResponseTime = undefined) {
    ...
    getTicketById(ticketId, headers, maxResponseTime = undefined) {
    ...
    updateTicket(ticketId, updatedData, headers, maxResponseTime = undefined) {
        const response = this.put(`${ENDPOINTS.TICKETS}/${ticketId}`, updatedData, headers);
    ...
    deleteTicket(ticketId, headers, maxResponseTime = undefined) {
